<script setup>
    ...
    const setEchartsThree = async () => {
        const option = {
            ...
            series: [{
                name: data[6][2].data[0].name,
                type: data[6][2].data[0].type,
                stack: 'Total',
                areaStyle: {},
                emphasis: {
                    focus: 'series'
                },
                data: data[6][2].data[0].value,
            },{
                name: data[6][2].data[1].name,
                type: data[6][2].data[1].type,
                stack: 'Total',
                areaStyle: {},
                emphasis: {
                    focus: 'series'
                },
                data: data[6][2].data[1].value,
            }]
        }
    ...
    const setEchartsFour = async () => {
        const option = {
            ...
            series: [{
                ...
                radius: ['0','65%'],
                center: ['50%', '50%'],
                data: data[6][3].data.sort(function (a, b) {
    ...
    const setEchartsFive = async () => {
        const option = {
            ...
            series: [{
                name: data[6][4].data[0].name,
                type: data[6][4].data[0].type,
                stack: 'Total',
                smooth: true,
                lineStyle: {
                    width: 0
                ...
                data: data[6][4].data[0].value,
            },{
                name: data[6][4].data[1].name,
                type: data[6][4].data[1].type,
                stack: 'Total',
                smooth: true,
                lineStyle: {
                    width: 0
